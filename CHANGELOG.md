...
- Merging the Engagement Knowledge Base (Phase C, done above) into `/api/evaluate`'s retrieval alongside the Framework Knowledge Base, source-tagging each result, and excluding `case_study_resolution`-purpose chunks. Design spec: `docs/superpowers/specs/2026-08-24-users-projects-engagement-kb-design.md`. Tracked as Backend API Integration below.
