...
* **Premium Theme**: a clean, high-contrast layout with HSL color tokens and Google Fonts integration (Outfit or Inter). **Superseded 2026-09-15**: the App-Wide Light Professional Retheme deliberately removed dark mode app-wide — there is no dark theme or light/dark toggle anywhere in the app today, a confirmed design decision, not an oversight. See `CLAUDE.md` Part 5.
